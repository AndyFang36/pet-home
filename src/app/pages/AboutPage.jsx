import {Box, Breadcrumbs, Container, Divider, ImageList, ImageListItem, Paper, Stack, Typography} from "@mui/material";
      ...
      <Container maxWidth={false} className="breadcrumb">
        ...
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography sx={{display: 'flex', alignItems: 'center'}}>
            <Grain sx={{mr: 0.5}} fontSize="inherit"/>关于我们
          </Typography>
        </Breadcrumbs>
      </Container>
      ...
      <Paper sx={{padding: "1rem"}}>
        <Stack component="article" spacing={2}>
          <Box component="section">
            <Typography variant="h4">关于宠物之家</Typography>
            <Divider/>
